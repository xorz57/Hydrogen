...
int main() {
    ...
    GLFWwindow *window = glfwCreateWindow(800, 600, "Example06", nullptr, nullptr);
    if (window == nullptr) {
        glfwTerminate();
        std::exit(EXIT_FAILURE);
    }
    ...
    vShaderFile.open("assets/shaders/default_vert.glsl");
    fShaderFile.open("assets/shaders/default_frag.glsl");
