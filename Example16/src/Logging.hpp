...
public:
    static void Init();
    [[nodiscard]] static std::shared_ptr<spdlog::logger> &GetServerLogger() { return sServerLogger; }
    [[nodiscard]] static std::shared_ptr<spdlog::logger> &GetClientLogger() { return sClientLogger; }
